...
<body>
    ...
    <div class="center">
        <h1><i class="fas fa-cross"></i> 註冊</h1>

        <form action="register_output.php" method="post">
            <div class="txt_field">
                <input type="text" name="name" maxlength="15" autofocus required>
                <span></span>
                <label>姓名</label>
            </div>
            <div class="txt_field">
                <input type="text" name="account_id" maxlength="15" required>
                <span></span>
                <label>帳號</label>
            </div>
            <div class="txt_field">
        ...
        <script>
            $('form').on('submit', function () {
                //送出表單前會觸發這部分
                $.ajax({
                    url: 'register_output.php',      //要傳送的頁面
                    method: 'post',
                        ...
                        if (res.success == true) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    document.location.href = "login.php";   /*確認轉址 */
                                }
                            });
                        } else {
